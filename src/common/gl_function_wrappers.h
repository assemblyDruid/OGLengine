...
namespace glfn
{
                     ...
                     const GLuint&& _texture_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        ...
        static const void (*local_glBindTexture)(GLenum, GLuint) = (const void (*)(
          GLenum target,
          GLuint texture))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glBindTexture");
    ...
    Impl_Clear(const GLbitfield&& _bit_mask_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (*local_glClear)(GLbitfield) = (const void (*)(
          GLbitfield))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glClear");
    ...
    Impl_CullFace(const GLenum&& _facet_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        ...
        static const void (*local_glCullFace)(GLenum) = (const void (*)(
          GLenum))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glCullFace");
                        ...
                        const GLuint*&& _textures_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (*local_glDeleteTextures)(GLsizei, const GLuint*) = (const void (*)(
          GLsizei,
          const GLuint*))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glDeleteTextures");
    ...
    Impl_DepthFunc(const GLenum&& _depth_comparison_mode_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        ...
        static const void (*local_glDepthFunc)(GLenum) = (const void (*)(
          GLenum))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glDepthFunc");
    ...
    Impl_Enable(const GLenum&& _capability_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        ...
        static const void (*local_glEnable)(
          GLenum) = (const void (*)(GLenum))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glEnable");
    ...
    Impl_FrontFace(const GLenum&& _winding_order_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        ...
        static const void (*lobal_glFrontFace)(GLenum) = (const void (*)(
          GLenum))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glFrontFace");
                     ...
                     GLuint*&& _textures_out _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (*local_glGenTextures)(GLsizei, GLuint*) = (const void (*)(
          GLsizei,
          GLuint*))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glGenTextures");
                   ...
                   GLfloat* _data_out _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (*local_glGetFloatv)(GLenum, GLfloat*) = (const void (*)(
          GLenum,
          GLfloat*))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glGetFloatv");
    ...
    Impl_GetString(const GLenum&& _name_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const GLubyte* (*local_glGetString)(
          GLenum) = (const GLubyte* (*)(GLenum))GetProcAddress(LoadLibraryA(ogl_dll_c_str),
                                                               "glGetString");
    ...
    Impl_GetStringi(const GLenum&& _name_in, const GLuint&& _index_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const GLubyte* (*local_glGetStringi)(
          GLenum,
          GLuint) = (const GLubyte* (*)(GLenum, GLuint))GetProcAddress(LoadLibraryA(ogl_dll_c_str),
                                                                       "glGetStringi");
                     ...
                     const GLint&& _paramter_value_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (*local_glPixelStorei)(GLenum, GLint) = (const void (*)(GLenum, GLint))
          GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glPixelStorei");
                    ...
                    const void*&& _data_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (*local_glTexImage2D)(
          ...
          const void*) = (const void (*)(GLenum,
                                         ...
                                         GLenum,
                                         GLenum,
                                         const void*))GetProcAddress(LoadLibraryA(ogl_dll_c_str),
                                                                     "glTexImage2D");
                      ...
                      const GLint&& _parameter_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (
          *local_glTexParameteri)(GLenum, GLenum, GLuint) = (const void (*)(GLenum, GLenum, GLuint))
          GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glTexParameteri");
                      ...
                      const GLfloat&& _parameter_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        static const void (*local_glTexParameterf)(GLenum, GLenum, GLfloat) = (const void (*)(
          GLenum,
          GLenum,
          GLfloat))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glTexParameterf");
                  ...
                  const GLsizei&& _height_in _DEBUG_FILE_AND_LINE_PARAMS_)
    {
        ...
        static const void (*local_glViewport)(GLint, GLint, GLsizei, GLsizei) = (const void (*)(
          ...
          GLint,
          GLsizei,
          GLsizei))GetProcAddress(LoadLibraryA(ogl_dll_c_str), "glViewport");
